...
#ifndef __itkNiftiImageIOHeader_h
#define __itkNiftiImageIOHeader_h
 ...
 * \ingroup ITKIONIFTI
 */
class NiftiImageIOHeader:public ImageIOBase
{
public:
  /** Standard class typedefs. */
  typedef NiftiImageIOHeader         Self;
  ...
  itkTypeMacro(NiftiImageIOHeader, Superclass);
...
private:
  ...
  NiftiImageIOHeader(const Self &);   //purposely not implemented
  void operator=(const Self &); //purposely not implemented
};
} // end namespace itk

#endif // __itkNiftiImageIOHeader_h
