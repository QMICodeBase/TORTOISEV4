...
NiftiImageIOHeader::NiftiImageIOHeader():
...
bool
NiftiImageIOHeader::MustRescale()
{
...
void NiftiImageIOHeader::Read(void *buffer)
{
...
// metadata dictionary.
void NiftiImageIOHeader::SetImageIOMetadataFromNIfTI()
{
  int             swap = 0;
...
void
NiftiImageIOHeader::SetImageIOOrientationFromNIfTI(unsigned short int dims)
{
...
void
NiftiImageIOHeader::SetNIfTIOrientationFromImageIO(unsigned short int origdims, unsigned short int dims)
{
  //
  // use NIFTI method 2
...
::Write(const void *buffer)
{
  ...
  if ( numComponents == 1
    ...
    nifti_image_write_hdr_img(this->m_NiftiImage,0,"wb");
