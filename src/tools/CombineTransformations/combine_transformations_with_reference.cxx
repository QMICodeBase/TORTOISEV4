...
int main( int argc , char * argv[] )
{
    if(argc<4)    
    {
        std::cout<<"Usage:   CombineTransformationsWithReference full_path_to_Refence_image_with_desired_spacing   full_path_to_trans1 full_path_to_trans2 ..............   full_path_to_trans_n "<<std::endl;
        std::cout<<"The output name will be combined_displacement.nii in the reference image folder"<<std::endl;
        return 0;
    }
    ...
    else
    {
        ...
        DisplacementFieldType::PixelType zero;
        zero.Fill(0);
        
        typename FieldReaderType::Pointer mreader=FieldReaderType::New();
        mreader->SetFileName(argv[1]);
        mreader->Update();    
        ...
        combined_displacement_field->FillBuffer(zero);
