...
int main( int argc , char * argv[] )
{
    if(argc<2)    
    {
        std::cout<< "Computes the Axial Diffusivity map from the diffusion tensor"<<std::endl;
        std::cout<<"Usage:   ComputeADMap full_path_to_tensor_image"<<std::endl;
        return 0;
    }
    ...
    std::string output_name=currdir + basename + std::string("_AD.nii");
