...
=========================================================================*/
// .NAME vtkTensorGlyphOkan - scale and orient glyph(s) according to tensor eigenvalues and eigenvectors
// .SECTION Description
// vtkTensorGlyphOkan is a filter that copies a geometric representation
...
#ifndef __vtkTensorGlyphOkan_h
#define __vtkTensorGlyphOkan_h

#include "vtkFiltersCoreModule.h"
#include "vtkPolyDataAlgorithm.h"

class VTKFILTERSCORE_EXPORT  vtkTensorGlyphOkan : public vtkPolyDataAlgorithm
{
public:
  vtkTypeMacro(vtkTensorGlyphOkan,vtkPolyDataAlgorithm);
...
private:
  vtkTensorGlyphOkan(const vtkTensorGlyphOkan&);  // Not implemented.
  void operator=(const vtkTensorGlyphOkan&);  // Not implemented.
};
