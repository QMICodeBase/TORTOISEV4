...
void DRTAMAS_Diffeo::SetDefaultStages()
{
...

    {
        ...
        curr_stage.update_gaussian_sigma=7;
        curr_stage.total_gaussian_sigma=7;
    ...
    }
    {
        ...
        curr_stage.update_gaussian_sigma=9;
        curr_stage.total_gaussian_sigma=7;
...

    {
        ...
        curr_stage.downsample_factor=2;
        curr_stage.learning_rate=0.25;
        curr_stage.update_gaussian_sigma=11.;
        curr_stage.total_gaussian_sigma=7;
...

    {
        ...
        {
            curr_stage.update_gaussian_sigma=13;
            curr_stage.total_gaussian_sigma=7;
        }
    ...
    }
    {
        ...
        {
            curr_stage.update_gaussian_sigma=11;
            curr_stage.total_gaussian_sigma=9;
        }
