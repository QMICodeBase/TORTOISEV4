 ...
 *
 *=========================================================================*/
#ifndef itkVectorGradientNDAnisotropicDiffusionFunctionOkan_hxx
#define itkVectorGradientNDAnisotropicDiffusionFunctionOkan_hxx


namespace itk
{
template <typename TImage>
double VectorGradientNDAnisotropicDiffusionFunctionOkan<TImage>::m_MIN_NORM = 1.0e-10;

template <typename TImage>
VectorGradientNDAnisotropicDiffusionFunctionOkan<TImage>::VectorGradientNDAnisotropicDiffusionFunctionOkan()
  : m_K(0.0)
{
  RadiusType r;
...
template <typename TImage>
auto
VectorGradientNDAnisotropicDiffusionFunctionOkan<TImage>::ComputeUpdate(const NeighborhoodType & it,
                                                                    void *,
                                                                    const FloatOffsetType &) -> PixelType
{
  ...
  for (unsigned int i = 0; i < ImageDimension; ++i)
  {
    ...
    for (unsigned int k = 3; k < VectorDimension; ++k)   
    {
...
//  if(it.GetIndex()[0]==9 && it.GetIndex()[1]==15 && it.GetIndex()[2]==10  )
 // {
   //   printf("mama\n");
   //   printf("%e %e %e %e %e \n",delta[0]*0.0625,delta[1]*0.0625,delta[2]*0.0625,delta[3]*0.0625,delta[4]*0.0625);
    //  exit(0);
 // }
