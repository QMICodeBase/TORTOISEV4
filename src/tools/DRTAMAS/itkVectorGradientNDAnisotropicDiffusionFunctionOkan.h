...
namespace itk
{
/** \class VectorGradientNDAnisotropicDiffusionFunctionOkan
 *
...
class ITK_TEMPLATE_EXPORT VectorGradientNDAnisotropicDiffusionFunctionOkan
  : public VectorAnisotropicDiffusionFunction<TImage>
{
public:
  ITK_DISALLOW_COPY_AND_MOVE(VectorGradientNDAnisotropicDiffusionFunctionOkan);

  /** Standard class type aliases. */
  using Self = VectorGradientNDAnisotropicDiffusionFunctionOkan;
  ...
  itkOverrideGetNameOfClassMacro(VectorGradientNDAnisotropicDiffusionFunctionOkan);
...
protected:
  VectorGradientNDAnisotropicDiffusionFunctionOkan();
  ~VectorGradientNDAnisotropicDiffusionFunctionOkan() override = default;
...
#  include "itkVectorGradientNDAnisotropicDiffusionFunctionOkan.hxx"
#endif
