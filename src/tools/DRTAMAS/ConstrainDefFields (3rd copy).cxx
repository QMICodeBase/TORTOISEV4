...
int main( int argc , char * argv[] )
{
    ...
    for(int v=0;v<fields.size();v++)
    {
        JacobianImageType::Pointer new_field_jacobian = GimmeNewJacobian(fields[v],avg_affine_inv_img);
        fields[v] = CreateFieldOutOfJacobian(new_field_jacobian,fields[v]);
    }
