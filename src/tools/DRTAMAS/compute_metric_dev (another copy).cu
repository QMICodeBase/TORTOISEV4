...

{
    ...
    for(int i=PER_GROUP*ii;i<PER_GROUP*ii+PER_GROUP;i++)
    {
        if(i<d_sz[0] && j <d_sz[1] && k<d_sz[2])
        {
           ...
           //     float metric_val = (F[2][2]-M[2][2])*(F[2][2]-M[2][2]);
...
/*
                ...
                float3 gradI[6], gradJ[6];
                for(int v=0;v<6;v++)
                {
                    gradI[v]= ComputeImageGradient(up_img,i,j,k,v);
                    gradJ[v]= ComputeImageGradient(down_img,i,j,k,v);
                }

                {
                    ...
                    /////for i
                    F2[0][0]=gradI[0].x; F2[0][1]=gradI[1].x; F2[0][2]=gradI[2].x;
                    F2[1][0]=gradI[1].x; F2[1][1]=gradI[3].x; F2[1][2]=gradI[4].x;
                    F2[2][0]=gradI[2].x; F2[2][1]=gradI[4].x; F2[2][2]=gradI[5].x;

                    M2[0][0]=gradJ[0].x; M2[0][1]=gradJ[1].x; M2[0][2]=gradJ[2].x;
                    M2[1][0]=gradJ[1].x; M2[1][1]=gradJ[3].x; M2[1][2]=gradJ[4].x;
                    M2[2][0]=gradJ[2].x; M2[2][1]=gradJ[4].x; M2[2][2]=gradJ[5].x;
                 ...
                 //   float smf= 2 *(F[2][2]-M[2][2])*F2[2][2];
                  //  float smm= 2 *(F[2][2]-M[2][2])*M2[2][2];
                    ...
                    float smf= 2 *(
                                 ...
                                 (F[1][1]-M[1][1])*F2[1][1]+
                                 (F[2][2]-M[2][2])*F2[2][2]+
                               2*(F[0][1]-M[0][1])*F2[0][1]+
                               2*(F[0][2]-M[0][2])*F2[0][2]+
                               2*(F[1][2]-M[1][2])*F2[1][2]
                                 );
                    ...
                    float smm= 2 *(
                                ...
                                (F[1][1]-M[1][1])*M2[1][1]+
                                (F[2][2]-M[2][2])*M2[2][2]+
                              2*(F[0][1]-M[0][1])*M2[0][1]+
                              2*(F[0][2]-M[0][2])*M2[0][2]+
                              2*(F[1][2]-M[1][2])*M2[1][2]
                                 );
                ...
                }
                {
                    ...
                    /////for j
                    F2[0][0]=gradI[0].y; F2[0][1]=gradI[1].y; F2[0][2]=gradI[2].y;
                    F2[1][0]=gradI[1].y; F2[1][1]=gradI[3].y; F2[1][2]=gradI[4].y;
                    F2[2][0]=gradI[2].y; F2[2][1]=gradI[4].y; F2[2][2]=gradI[5].y;

                    M2[0][0]=gradJ[0].y; M2[0][1]=gradJ[1].y; M2[0][2]=gradJ[2].y;
                    M2[1][0]=gradJ[1].y; M2[1][1]=gradJ[3].y; M2[1][2]=gradJ[4].y;
                    M2[2][0]=gradJ[2].y; M2[2][1]=gradJ[4].y; M2[2][2]=gradJ[5].y;
                ...
                }
                {
                    ...
                    /////for i
                    F2[0][0]=gradI[0].z; F2[0][1]=gradI[1].z; F2[0][2]=gradI[2].z;
                    F2[1][0]=gradI[1].z; F2[1][1]=gradI[3].z; F2[1][2]=gradI[4].z;
                    F2[2][0]=gradI[2].z; F2[2][1]=gradI[4].z; F2[2][2]=gradI[5].z;

                    M2[0][0]=gradJ[0].z; M2[0][1]=gradJ[1].z; M2[0][2]=gradJ[2].z;
                    M2[1][0]=gradJ[1].z; M2[1][1]=gradJ[3].z; M2[1][2]=gradJ[4].z;
                    M2[2][0]=gradJ[2].z; M2[2][1]=gradJ[4].z; M2[2][2]=gradJ[5].z;
                            ...
                            {
                                {
                                    ...
                                    float temp[3][3], res1[3][3], res2[3][3];
                                    MatrixMultiply(Rneg,F,temp);
                                    MatrixMultiply(temp,Rf,res1);

                                    MatrixMultiply(RfT,F,temp);
                                    MatrixMultiply(temp,Rpos,res2);

                                    updateF[px]+= 2*(F[0][0]-M[0][0]) * (res1[0][0]+ res2[0][0])+
                                              4*(F[0][1]-M[0][1]) * (res1[0][1]+ res2[0][1])+
                                              4*(F[0][2]-M[0][2]) * (res1[0][2]+ res2[0][2])+
                                              2*(F[1][1]-M[1][1]) * (res1[1][1]+ res2[1][1])+
                                              4*(F[1][2]-M[1][2]) * (res1[1][2]+ res2[1][2])+
                                              2*(F[2][2]-M[2][2]) * (res1[2][2]+ res2[2][2]);
                                }
                                {
                                    float Rpos[3][3]={0}, Rneg[3][3]={0} ;
                                    ...
                                    updateM[px]-= 2*(F[0][0]-M[0][0]) * (res1[0][0]+ res2[0][0])+
                                              4*(F[0][1]-M[0][1]) * (res1[0][1]+ res2[0][1])+
                                              4*(F[0][2]-M[0][2]) * (res1[0][2]+ res2[0][2])+
                                              2*(F[1][1]-M[1][1]) * (res1[1][1]+ res2[1][1])+
                                              4*(F[1][2]-M[1][2]) * (res1[1][2]+ res2[1][2])+
