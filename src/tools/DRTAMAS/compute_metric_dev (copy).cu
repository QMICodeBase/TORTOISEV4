        ...
        if(i<d_sz[0] && j <d_sz[1] && k<d_sz[2])
        {
            ...
            {                
...

                {
                    ...
                    F2[1][0]=gradI[2].x; F2[1][1]=gradI[3].x; F2[1][2]=gradI[4].x;
                    F2[2][0]=gradI[2].x; F2[2][1]=gradI[4].x; F2[2][2]=gradI[5].x;

                    M2[0][0]=gradJ[0].x; M2[0][1]=gradJ[1].x; M2[0][2]=gradJ[2].x;
                    M2[1][0]=gradJ[2].x; M2[1][1]=gradJ[3].x; M2[1][2]=gradJ[4].x;
                ...
                }
                {
                    ...
                    F2[1][0]=gradI[2].y; F2[1][1]=gradI[3].y; F2[1][2]=gradI[4].y;
                    F2[2][0]=gradI[2].y; F2[2][1]=gradI[4].y; F2[2][2]=gradI[5].y;

                    M2[0][0]=gradJ[0].y; M2[0][1]=gradJ[1].y; M2[0][2]=gradJ[2].y;
                    M2[1][0]=gradJ[2].y; M2[1][1]=gradJ[3].y; M2[1][2]=gradJ[4].y;
                ...
                }
                {
                    ...
                    F2[1][0]=gradI[2].z; F2[1][1]=gradI[3].z; F2[1][2]=gradI[4].z;
                    F2[2][0]=gradI[2].z; F2[2][1]=gradI[4].z; F2[2][2]=gradI[5].z;

                    M2[0][0]=gradJ[0].z; M2[0][1]=gradJ[1].z; M2[0][2]=gradJ[2].z;
                    M2[1][0]=gradJ[2].z; M2[1][1]=gradJ[3].z; M2[1][2]=gradJ[4].z;
                   ...
                   float &metric_value		   )
{
    ...
    ComputeDeviatoric_kernel<<< blockSize,gridSize>>>( up_img);
    gpuErrchk(cudaPeekAtLastError());
    gpuErrchk(cudaDeviceSynchronize());
    ComputeDeviatoric_kernel<<< blockSize,gridSize>>>( down_img);
    gpuErrchk(cudaPeekAtLastError());
    gpuErrchk(cudaDeviceSynchronize());
