...
namespace itk
{
/** \class VectorGradientAnisotropicDiffusionImageFilterOkan
 *
...
class ITK_TEMPLATE_EXPORT VectorGradientAnisotropicDiffusionImageFilterOkan
  : public AnisotropicDiffusionImageFilter<TInputImage, TOutputImage>
{
public:
  ITK_DISALLOW_COPY_AND_MOVE(VectorGradientAnisotropicDiffusionImageFilterOkan);

  /** Standard class type aliases. */
  using Self = VectorGradientAnisotropicDiffusionImageFilterOkan;
  ...
  itkOverrideGetNameOfClassMacro(VectorGradientAnisotropicDiffusionImageFilterOkan);
...
protected:
  VectorGradientAnisotropicDiffusionImageFilterOkan()
  {
    auto p = VectorGradientNDAnisotropicDiffusionFunctionOkan<UpdateBufferType>::New();
    this->SetDifferenceFunction(p);
  }

  ~VectorGradientAnisotropicDiffusionImageFilterOkan() override = default;
