...
{  
    ...
    std::string commandDescription = std::string( "This program reorients a NIFTI image with a given orientation to a standard axial orientation.  " )
      + std::string( "The Bmatrix is reoriented accordingly as well. " );
...
void Reorient_Image_PARSER::InitializeCommandLineOptions()
{
    ...
    {
        std::string description = std::string( "Output name of the NIFTI file." );
    ...
    {
        std::string description = std::string( "Phase encoding direction. Optional. Will be read from json file if present. Options: vertical/horisontal/slice" );
...
std::string Reorient_Image_PARSER::getPhase()
{
