...
int main( int argc , char * argv[] )
{
    if(argc<2)    
    {
        std::cout<< "Computes the Westin-Spherical map from the diffusion tensor"<<std::endl;
        std::cout<<"Usage:   ComputeWSMap full_path_to_tensor_image"<<std::endl;
        return 0;
    }
    ...
    std::string output_name=currdir + basename + std::string("_WS.nii");
