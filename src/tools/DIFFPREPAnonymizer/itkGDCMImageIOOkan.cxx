...
GDCMImageIOOkan::GDCMImageIOOkan()
{
  ...
  m_ByteOrder = itk::CommonEnums::IOByteOrder::LittleEndian;     //default
  m_FileType = itk::CommonEnums::IOFile::Binary;            //default...always true
  m_RescaleSlope = 1.0;
  ...
  m_InternalComponentType = itk::CommonEnums::IOComponent::UNKNOWNCOMPONENTTYPE;
...
// GDCM image file.
bool GDCMImageIOOkan::CanReadFile(const char *filename)
{
  std::ifstream file;
  try
    {
...
void GDCMImageIOOkan::Read(void *pointer)
{
...
void GDCMImageIOOkan::InternalReadImageInformation()
{
  // ensure file can be opened for reading, before doing any more work
  std::ifstream inputFileStream;
  // let any exceptions propagate
  ...
  switch ( pixeltype )
    ...
    case gdcm::PixelFormat::INT8:
      m_InternalComponentType = ImageIOBase::IOComponentEnum::CHAR; // Is it signed char ?
      break;
    case gdcm::PixelFormat::UINT8:
      m_InternalComponentType = ImageIOBase::IOComponentEnum::UCHAR;
      break;
    /* INT12 / UINT12 should not happen anymore in any modern DICOM */
    case gdcm::PixelFormat::INT12:
      m_InternalComponentType = ImageIOBase::IOComponentEnum::SHORT;
      break;
    case gdcm::PixelFormat::UINT12:
      m_InternalComponentType = ImageIOBase::IOComponentEnum::USHORT;
      break;
    ...
    case gdcm::PixelFormat::INT32:
      m_InternalComponentType = ImageIOBase::IOComponentEnum::INT;
      break;
    case gdcm::PixelFormat::UINT32:
      m_InternalComponentType = ImageIOBase::IOComponentEnum::UINT;
      break;
    //case gdcm::PixelFormat::FLOAT16: // TODO
    case gdcm::PixelFormat::FLOAT32:
      m_InternalComponentType = ImageIOBase::IOComponentEnum::FLOAT;
      break;
    case gdcm::PixelFormat::FLOAT64:
      m_InternalComponentType = ImageIOBase::IOComponentEnum::DOUBLE;
      break;
    default:
  ...
  m_ComponentType = itk::CommonEnums::IOComponent::UNKNOWNCOMPONENTTYPE;
  switch ( outputpt )
    {
    case gdcm::PixelFormat::INT8:
      m_ComponentType = ImageIOBase::IOComponentEnum::CHAR; // Is it signed char ?
      break;
    case gdcm::PixelFormat::UINT8:
      m_ComponentType = ImageIOBase::IOComponentEnum::UCHAR;
      break;
    /* INT12 / UINT12 should not happen anymore in any modern DICOM */
    case gdcm::PixelFormat::INT12:
      m_ComponentType = ImageIOBase::IOComponentEnum::SHORT;
      break;
    case gdcm::PixelFormat::UINT12:
      m_ComponentType = ImageIOBase::IOComponentEnum::USHORT;
      break;
    case gdcm::PixelFormat::INT16:
      m_ComponentType = ImageIOBase::IOComponentEnum::SHORT;
      break;
    ...
    // RT / SC have 32bits
    case gdcm::PixelFormat::INT32:
      m_ComponentType = ImageIOBase::IOComponentEnum::INT;
      break;
    case gdcm::PixelFormat::UINT32:
      m_ComponentType = ImageIOBase::IOComponentEnum::UINT;
      break;
    //case gdcm::PixelFormat::FLOAT16: // TODO
    case gdcm::PixelFormat::FLOAT32:
      m_ComponentType = ImageIOBase::IOComponentEnum::FLOAT;
      break;
    case gdcm::PixelFormat::FLOAT64:
      m_ComponentType = ImageIOBase::IOComponentEnum::DOUBLE;
      break;
    default:
  ...
  if ( m_NumberOfComponents == 1 )
    {
    this->SetPixelType(itk::CommonEnums::IOPixel::SCALAR);
    }
  else
    {
    this->SetPixelType(itk::CommonEnums::IOPixel::RGB); // What if image is YBR ? This is a problem since
  ...
  for (; it != ds.End(); ++it )
    ...
    int gn= tag.GetGroup();
    int en = tag.GetElement();
    if((gn==41 && en==4112) || (gn==41 && en==4128))
    {
        const gdcm::ByteValue *bv = ref.GetByteValue();
        if ( bv )
        {
            std::string encodedValue(bv->GetPointer(), 14008);
...
void GDCMImageIOOkan::ReadImageInformation()
{
  this->InternalReadImageInformation();
}

bool GDCMImageIOOkan::CanWriteFile(const char *name)
{
...
void GDCMImageIOOkan::WriteImageInformation()
{}

void GDCMImageIOOkan::Write(const void *buffer)
{
  ...
  while ( itr != end )
    ...
    if ( b /*tag != gdcm::Tag(0xffff,0xffff)*/ /*dictEntry*/ )
      ...
      if ( dictEntry.GetVR() == gdcm::VR::SQ )
        ...
        if ( !tag.IsGroupLength() ) // Get rid of group length, they are not
          ...
          if ( vrtype & ( gdcm::VR::UI ) )
            ...
            {
              if(key!="0029|1010" && key!="0029|1020")
              {
              ...
              {
                 // const gdcm::String<> si = sf.FromString( tag, value.c_str(), value.size() );
                  const gdcm::String<> si = value;
                  //const gdcm::String<> si = sf.FromString( tag, mm, 14008 );
                  de.SetByteValue( si.c_str(), static_cast<uint32_t>(si.size()) );
              }
      ...
      if ( key == ITK_NumberOfDimensions )
        ...
        {
        itkDebugMacro(
          << "GDCMImageIOOkan: non-DICOM and non-ITK standard key = " << key);
        }
      }
  ...
  switch ( this->GetComponentType() )
    {
    case ImageIOBase::IOComponentEnum::CHAR:
      pixeltype = gdcm::PixelFormat::INT8;
      break;
    case ImageIOBase::IOComponentEnum::UCHAR:
      pixeltype = gdcm::PixelFormat::UINT8;
      break;
    case ImageIOBase::IOComponentEnum::SHORT:
      pixeltype = gdcm::PixelFormat::INT16;
      break;
    case ImageIOBase::IOComponentEnum::USHORT:
      pixeltype = gdcm::PixelFormat::UINT16;
      break;
    case ImageIOBase::IOComponentEnum::INT:
      pixeltype = gdcm::PixelFormat::INT32;
      break;
    case ImageIOBase::IOComponentEnum::UINT:
      pixeltype = gdcm::PixelFormat::UINT32;
      break;
    //Disabling FLOAT and DOUBLE for now...
    case ImageIOBase::IOComponentEnum::FLOAT:
      pixeltype = gdcm::PixelFormat::FLOAT32;
      break;
    case ImageIOBase::IOComponentEnum::DOUBLE:
  ...
  else if( this->GetInternalComponentType() != itk::CommonEnums::IOComponent::UNKNOWNCOMPONENTTYPE )
    {
    auto internalComponentType = this->GetInternalComponentType();
...
void GDCMImageIOOkan::GetPatientName(char *name)
{
  MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void GDCMImageIOOkan::GetPatientID(char *name)
{
  MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void GDCMImageIOOkan::GetPatientSex(char *name)
{
  MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void GDCMImageIOOkan::GetPatientAge(char *name)
{
  MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void GDCMImageIOOkan::GetStudyID(char *name)
{
  MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void GDCMImageIOOkan::GetPatientDOB(char *name)
{
  MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void GDCMImageIOOkan::GetStudyDescription(char *name)
{
  MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void GDCMImageIOOkan::GetBodyPart(char *name)
{
  MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void GDCMImageIOOkan::GetNumberOfSeriesInStudy(char *name)
{
  MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void GDCMImageIOOkan::GetNumberOfStudyRelatedSeries(char *name)
{
  MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void GDCMImageIOOkan::GetStudyDate(char *name)
{
  MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void GDCMImageIOOkan::GetModality(char *name)
{
  MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void GDCMImageIOOkan::GetManufacturer(char *name)
{
  MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void GDCMImageIOOkan::GetInstitution(char *name)
{
  MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void GDCMImageIOOkan::GetModel(char *name)
{
  MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void GDCMImageIOOkan::GetScanOptions(char *name)
{
  MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
bool GDCMImageIOOkan::GetValueFromTag(const std::string & tag, std::string & value)
{
  MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
bool GDCMImageIOOkan::GetLabelFromTag(const std::string & tag,
                                  std::string & labelId)
{
  gdcm::Tag t;
...
void GDCMImageIOOkan::PrintSelf(std::ostream & os, Indent indent) const
{
