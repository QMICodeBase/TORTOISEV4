 ...
 *
 *=========================================================================*/
#ifndef itkGDCMImageIOOkan_h
#define itkGDCMImageIOOkan_h
...
class ITKIOGDCM_EXPORT GDCMImageIOOkan:public ImageIOBase
{
public:
  /** Standard class typedefs. */
  typedef GDCMImageIOOkan          Self;
  ...
  itkTypeMacro(GDCMImageIOOkan, Superclass);
   ...
   * LoadSequences. When instances of GDCMImageIOOkan are created, the
  ...
  /** Global method to define the default value for
   * LoadPrivateTags. When instances of GDCMImageIOOkan are created, the
...
private:
  ITK_DISALLOW_COPY_AND_MOVE(GDCMImageIOOkan);
  ...
  ImageIOBase::IOComponentEnum m_InternalComponentType;
  InternalHeader *             m_DICOMHeader;
};
} // end namespace itk

#endif // itkGDCMImageIOOkan_h
