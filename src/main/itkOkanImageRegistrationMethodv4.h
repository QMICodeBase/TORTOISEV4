 ...
 *
 *=========================================================================*/
#ifndef itkOkanImageRegistrationMethodv4_h
#define itkOkanImageRegistrationMethodv4_h
...
/** \class OkanImageRegistrationMethodv4
...
class ITK_TEMPLATE_EXPORT OkanImageRegistrationMethodv4
:public ProcessObject
{
public:
  /** Standard class typedefs. */
  typedef OkanImageRegistrationMethodv4                 Self;
  ...
  typedef typename ObjectToObjectOptimizerBaseTemplate<RealType>::ScalesType                          OptimizerWeightsType;
...
protected:
  ...
  virtual ~OkanImageRegistrationMethodv4();
...
#include "itkOkanImageRegistrationMethodv4.hxx"
#endif
