 ...
 *
 *=========================================================================*/
#ifndef itkLinearInterpolateImageFunctionOkan_hxx
#define itkLinearInterpolateImageFunctionOkan_hxx
...
auto
LinearInterpolateImageFunctionOkan<TInputImage, TCoordRep>::EvaluateUnoptimized(const ContinuousIndexType & index) const
  -> OutputType
{
...
template <typename TInputImage, typename TCoordRep>
void
LinearInterpolateImageFunctionOkan<TInputImage, TCoordRep>::PrintSelf(std::ostream & os, Indent indent) const
{
