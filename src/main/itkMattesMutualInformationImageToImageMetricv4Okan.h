 ...
 *
 *=========================================================================*/
#ifndef itkMattesMutualInformationImageToImageMetricv4Okan_h
#define itkMattesMutualInformationImageToImageMetricv4Okan_h
...
/** \class MattesMutualInformationImageToImageMetricv4Okan
 *
...
template <typename TFixedImage, typename TMovingImage, typename TVirtualImage = TFixedImage,
          ...
          >
class ITK_TEMPLATE_EXPORT MattesMutualInformationImageToImageMetricv4Okan :
  public ImageToImageMetricv4<TFixedImage, TMovingImage, TVirtualImage, TInternalComputationValueType, TMetricTraits>
{
public:
  ITK_DISALLOW_COPY_AND_ASSIGN(MattesMutualInformationImageToImageMetricv4Okan);

  /** Standard class type aliases. */
  using Self = MattesMutualInformationImageToImageMetricv4Okan;
  ...
  itkTypeMacro(MattesMutualInformationImageToImageMetricv4Okan, ImageToImageMetricv4);
  ...
  void FinalizeThread( const ThreadIdType threadId ) override;
    ...
    void SetFixedMin(double aa){m_FixedImageTrueMin=aa;};
  void SetFixedMax(double aa){m_FixedImageTrueMax=aa;};
  void SetMovingMin(double aa){m_MovingImageTrueMin=aa;};
  void SetMovingMax(double aa){m_MovingImageTrueMax=aa;};

protected:
  MattesMutualInformationImageToImageMetricv4Okan();
  ~MattesMutualInformationImageToImageMetricv4Okan() override = default;
...
#include "itkMattesMutualInformationImageToImageMetricv4Okan.hxx"
#endif
