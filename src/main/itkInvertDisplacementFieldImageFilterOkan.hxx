...
template <typename TInputImage, typename TOutputImage>
void
InvertDisplacementFieldImageFilterOkan<TInputImage, TOutputImage>::SetInterpolator(InterpolatorType * interpolator)
{
...
template <typename TInputImage, typename TOutputImage>
void
InvertDisplacementFieldImageFilterOkan<TInputImage, TOutputImage>::GenerateData()
{
...
template <typename TInputImage, typename TOutputImage>
void
InvertDisplacementFieldImageFilterOkan<TInputImage, TOutputImage>::DynamicThreadedGenerateData(const RegionType & region)
{
...
template <typename TInputImage, typename TOutputImage>
void
InvertDisplacementFieldImageFilterOkan<TInputImage, TOutputImage>::PrintSelf(std::ostream & os, Indent indent) const
{
