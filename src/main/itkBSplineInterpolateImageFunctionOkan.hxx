 ...
 *
 *=========================================================================*/
#ifndef itkBSplineInterpolateImageFunctionOkan_hxx
#define itkBSplineInterpolateImageFunctionOkan_hxx
...
BSplineInterpolateImageFunctionOkan<TImageType, TCoordRep, TCoefficientType>::BSplineInterpolateImageFunctionOkan()
{
...
template <typename TImageType, typename TCoordRep, typename TCoefficientType>
void
BSplineInterpolateImageFunctionOkan<TImageType, TCoordRep, TCoefficientType>::PrintSelf(std::ostream & os,
                                                                                    Indent         indent) const
{
...
template <typename TImageType, typename TCoordRep, typename TCoefficientType>
void
BSplineInterpolateImageFunctionOkan<TImageType, TCoordRep, TCoefficientType>::SetInputImage(const TImageType * inputData)
{
  if (inputData)
  {
...
template <typename TImageType, typename TCoordRep, typename TCoefficientType>
void
BSplineInterpolateImageFunctionOkan<TImageType, TCoordRep, TCoefficientType>::SetSplineOrder(unsigned int SplineOrder)
{
...
template <typename TImageType, typename TCoordRep, typename TCoefficientType>
void
BSplineInterpolateImageFunctionOkan<TImageType, TCoordRep, TCoefficientType>::SetNumberOfWorkUnits(
...
template <typename TImageType, typename TCoordRep, typename TCoefficientType>
void
BSplineInterpolateImageFunctionOkan<TImageType, TCoordRep, TCoefficientType>::SetInterpolationWeights(
...
template <typename TImageType, typename TCoordRep, typename TCoefficientType>
void
BSplineInterpolateImageFunctionOkan<TImageType, TCoordRep, TCoefficientType>::SetDerivativeWeights(
  const ContinuousIndexType & x,
  const vnl_matrix<long> &    EvaluateIndex,
  vnl_matrix<double> &        weights,
  unsigned int                splineOrder) const
...
template <typename TImageType, typename TCoordRep, typename TCoefficientType>
void
BSplineInterpolateImageFunctionOkan<TImageType, TCoordRep, TCoefficientType>::GeneratePointsToIndex()
{
...
template <typename TImageType, typename TCoordRep, typename TCoefficientType>
void
BSplineInterpolateImageFunctionOkan<TImageType, TCoordRep, TCoefficientType>::DetermineRegionOfSupport(
...
template <typename TImageType, typename TCoordRep, typename TCoefficientType>
void
BSplineInterpolateImageFunctionOkan<TImageType, TCoordRep, TCoefficientType>::ApplyMirrorBoundaryConditions(
  vnl_matrix<long> & evaluateIndex,
  unsigned int       splineOrder) const
{
...
template <typename TImageType, typename TCoordRep, typename TCoefficientType>
typename BSplineInterpolateImageFunctionOkan<TImageType, TCoordRep, TCoefficientType>::OutputType
BSplineInterpolateImageFunctionOkan<TImageType, TCoordRep, TCoefficientType>::EvaluateAtContinuousIndexInternal(
  const ContinuousIndexType & x,
  vnl_matrix<long> &          evaluateIndex,
  vnl_matrix<double> &        weights) const
{
  ...
  for (unsigned int p = 0; p < m_MaxNumberInterpolationPoints; ++p)
  {
    ...
    if(mask_img)
    {
        float mask_val = mask_img->GetPixel(coefficientIndex);
        if(mask_val>0.1)
        {
...
template <typename TImageType, typename TCoordRep, typename TCoefficientType>
void
BSplineInterpolateImageFunctionOkan<TImageType, TCoordRep, TCoefficientType>::
...
template <typename TImageType, typename TCoordRep, typename TCoefficientType>
typename BSplineInterpolateImageFunctionOkan<TImageType, TCoordRep, TCoefficientType>::CovariantVectorType
BSplineInterpolateImageFunctionOkan<TImageType, TCoordRep, TCoefficientType>::EvaluateDerivativeAtContinuousIndexInternal(
  const ContinuousIndexType & x,
  vnl_matrix<long> &          evaluateIndex,
  vnl_matrix<double> &        weights,
  vnl_matrix<double> &        weightsDerivative) const
