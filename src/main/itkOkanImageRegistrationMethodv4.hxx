 ...
 *
 *=========================================================================*/
#ifndef itkOkanImageRegistrationMethodv4_hxx
#define itkOkanImageRegistrationMethodv4_hxx
...
OkanImageRegistrationMethodv4<TFixedImage, TMovingImage, TTransform, TVirtualImage, TPointSet>
::OkanImageRegistrationMethodv4()
{
...
template<typename TFixedImage, typename TMovingImage, typename TTransform, typename TVirtualImage, typename TPointSet>
const typename OkanImageRegistrationMethodv4<TFixedImage, TMovingImage, TTransform, TVirtualImage, TPointSet>::FixedImageType *
OkanImageRegistrationMethodv4<TFixedImage, TMovingImage, TTransform, TVirtualImage, TPointSet>
...
template<typename TFixedImage, typename TMovingImage, typename TTransform, typename TVirtualImage, typename TPointSet>
const typename OkanImageRegistrationMethodv4<TFixedImage, TMovingImage, TTransform, TVirtualImage, TPointSet>::MovingImageType *
OkanImageRegistrationMethodv4<TFixedImage, TMovingImage, TTransform, TVirtualImage, TPointSet>
...
template<typename TFixedImage, typename TMovingImage, typename TTransform, typename TVirtualImage, typename TPointSet>
const typename OkanImageRegistrationMethodv4<TFixedImage, TMovingImage, TTransform, TVirtualImage, TPointSet>::PointSetType *
OkanImageRegistrationMethodv4<TFixedImage, TMovingImage, TTransform, TVirtualImage, TPointSet>
...
::InitializeRegistrationAtEachLevel( const SizeValueType level )
{
  ...
  if( level == 0 )
    ...
    if( this->m_Metric->GetMetricCategory() == MetricType::MetricCategoryEnum::MULTI_METRIC )
      {
  ...
  if( level == 0 )
    ...
    if( this->m_NumberOfMetrics == 1 && this->m_Metric->GetMetricCategory() == MetricType::MetricCategoryEnum::IMAGE_METRIC )
      {
      this->m_FirstImageMetricIndex = 0;
      }
    else if( this->m_Metric->GetMetricCategory() == MetricType::MetricCategoryEnum::MULTI_METRIC )
      {
      for( SizeValueType n = 0; n < this->m_NumberOfMetrics; n++ )
        {
        if( multiMetric->GetMetricQueue()[n]->GetMetricCategory() == MetricType::MetricCategoryEnum::IMAGE_METRIC )
          {
    ...
    for( SizeValueType n = 0; n < this->m_NumberOfMetrics; n++ )
      ...
      if( this->m_Metric->GetMetricCategory() == MetricType::MetricCategoryEnum::IMAGE_METRIC ||
          ( this->m_Metric->GetMetricCategory() == MetricType::MetricCategoryEnum::MULTI_METRIC &&
            multiMetric->GetMetricQueue()[n]->GetMetricCategory() == MetricType::MetricCategoryEnum::IMAGE_METRIC ) )
        {
        ...
        else if( this->m_Metric->GetMetricCategory() == MetricType::MetricCategoryEnum::IMAGE_METRIC )
          {
  ...
  if( this->m_Metric->GetMetricCategory() == MetricType::MetricCategoryEnum::MULTI_METRIC )
    ...
    for( SizeValueType n = 0; n < multiMetric->GetNumberOfMetrics(); n++ )
      ...
      else if( multiMetric->GetMetricQueue()[n]->GetMetricCategory() == MetricType::MetricCategoryEnum::POINT_SET_METRIC )
        {
        if( currentLevelVirtualDomainImage.IsNotNull() )
          {
  ...
  for( SizeValueType n = 0; n < this->m_NumberOfMetrics; n++ )
    ...
    if( this->m_Metric->GetMetricCategory() == MetricType::MetricCategoryEnum::IMAGE_METRIC ||
      ...
      if( this->m_Metric->GetMetricCategory() == MetricType::MetricCategoryEnum::MULTI_METRIC )
        ...
        ( this->m_Metric->GetMetricCategory() == MetricType::MetricCategoryEnum::MULTI_METRIC &&
          multiMetric->GetMetricQueue()[n]->GetMetricCategory() == MetricType::MetricCategoryEnum::POINT_SET_METRIC ) )
      {
 ...
 */
template<typename TFixedImage, typename TMovingImage, typename TTransform, typename TVirtualImage, typename TPointSet>
const typename  OkanImageRegistrationMethodv4<TFixedImage, TMovingImage, TTransform, TVirtualImage, TPointSet>::TransformParametersAdaptorsContainerType &
OkanImageRegistrationMethodv4<TFixedImage, TMovingImage, TTransform, TVirtualImage, TPointSet>
...
template<typename TFixedImage, typename TMovingImage, typename TTransform, typename TVirtualImage, typename TPointSet>
typename OkanImageRegistrationMethodv4<TFixedImage, TMovingImage, TTransform, TVirtualImage, TPointSet>::VirtualImageBaseConstPointer
OkanImageRegistrationMethodv4<TFixedImage, TMovingImage, TTransform, TVirtualImage, TPointSet>
::GetCurrentLevelVirtualDomainImage()
{
  ...
  if( this->m_Metric->GetMetricCategory() == MetricType::MetricCategoryEnum::IMAGE_METRIC )
    ...
    {
    typename MultiMetricType::Pointer multiMetric = dynamic_cast<MultiMetricType *>( this->m_Metric.GetPointer() );
    if( multiMetric->GetMetricQueue()[0]->GetMetricCategory() == MetricType::MetricCategoryEnum::POINT_SET_METRIC )
      {
 ...
 */
template<typename TFixedImage, typename TMovingImage, typename TTransform, typename TVirtualImage, typename TPointSet>
typename OkanImageRegistrationMethodv4<TFixedImage, TMovingImage, TTransform, TVirtualImage, TPointSet>::DecoratedOutputTransformType *
OkanImageRegistrationMethodv4<TFixedImage, TMovingImage, TTransform, TVirtualImage, TPointSet>
::GetOutput()
{
...
template<typename TFixedImage, typename TMovingImage, typename TTransform, typename TVirtualImage, typename TPointSet>
const typename OkanImageRegistrationMethodv4<TFixedImage, TMovingImage, TTransform, TVirtualImage, TPointSet>::DecoratedOutputTransformType *
OkanImageRegistrationMethodv4<TFixedImage, TMovingImage, TTransform, TVirtualImage, TPointSet>
::GetOutput() const
{
...
template<typename TFixedImage, typename TMovingImage, typename TTransform, typename TVirtualImage, typename TPointSet>
typename OkanImageRegistrationMethodv4<TFixedImage, TMovingImage, TTransform, TVirtualImage, TPointSet>::OutputTransformType *
OkanImageRegistrationMethodv4<TFixedImage, TMovingImage, TTransform, TVirtualImage, TPointSet>
...
template<typename TFixedImage, typename TMovingImage, typename TTransform, typename TVirtualImage, typename TPointSet>
const typename OkanImageRegistrationMethodv4<TFixedImage, TMovingImage, TTransform, TVirtualImage, TPointSet>::OutputTransformType *
OkanImageRegistrationMethodv4<TFixedImage, TMovingImage, TTransform, TVirtualImage, TPointSet>
::GetTransform() const
{
