#ifndef _RIGIDTRANSFORMIMAGE_CXX
#define _RIGIDTRANSFORMIMAGE_CXX

#include "rigid_transform_image.h"


CUDAIMAGE::Pointer RigidTransformImageC(CUDAIMAGE::Pointer main_image, TransformType::Pointer tp,CUDAIMAGE::Pointer target_img)
{
    ...
    RigidTransformImage_cuda(main_image->GetTexture(),
